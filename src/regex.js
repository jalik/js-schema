 ...
 * @type {RegExp}
 */
export const DateTimeRegExp = /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[0-1])T(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])(?:Z|[+-](0[0-9]|1[0-9]|2[0-3]):([0-5][0-9]))$/;
 ...
 * @type {RegExp}
 */
export const TimeRegExp = /^(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])(?:Z|[+-](0[0-9]|1[0-9]|2[0-3]):([0-5][0-9]))$/;
