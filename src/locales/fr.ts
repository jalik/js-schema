...
const fr: LocaleData = {
  ...
  [ERROR_FIELD_CONST]: 'Le champ doit être égal à "{constant}".',
  [ERROR_FIELD_CONTAINS]: 'Le champ ne contient pas d\'item valide.',
  ...
  [ERROR_FIELD_MAX_CONTAINS]: 'Le champ ne doit pas contenir plus de {maxContains} valeurs correspondant à "contains".',
  ...
  [ERROR_FIELD_MAX_PROPERTIES]: 'Le champ doit ne doit pas avoir plus de {maxProperties} propriétés.',
  ...
  [ERROR_FIELD_MIN_CONTAINS]: 'Le champ doit contenir au moins {minContains} valeurs correspondant à "contains".',
  ...
  [ERROR_FIELD_MIN_PROPERTIES]: 'Le champ doit avoir au moins {minProperties} propriétés.',
  ...
  [ERROR_FIELD_PROPERTY_NAMES]: 'Le nom du champ est invalide.',
  [ERROR_FIELD_REF]: 'Le champ a une référence invalide "{ref}".',
