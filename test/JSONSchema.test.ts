...
const stringSchema = new JSONSchema({
  type: 'object',
  properties: {
    string: {
      type: 'string',
...
const baseSchema = new JSONSchema({
  properties: {
    array: {
      type: ['number'],
      required: true
    ...
    embedded: stringSchema.toJSON(),
    embeddedArray: {
      type: 'array',
      items: stringSchema.toJSON()
    },
    number: {
      type: 'number',
      required: true
...
describe('clone()', () => {
  it('should create a copy of the schema', () => {
    ...
    expect(baseSchema.clone().toJSON()).toMatchObject(baseSchema.toJSON())
  })
})
...
describe('getProperty()', () => {
  describe('with valid property name', () => {
    it('should return property definition', () => {
      expect(baseSchema.getProperty('string')).toBeDefined()
    })
  })

  describe('with invalid property name', () => {
    it('should not throw', () => {
      expect(() => baseSchema.getProperty(
        // @ts-expect-error key not defined
        'unknown'
      )).not.toThrow()
    })
...
describe('isRequired()', () => {
  describe('with required: true', () => {
    it('should return true', () => {
      const schema = new JSONSchema({ required: true })
  ...
  describe('with required: false', () => {
    it('should return false', () => {
      const schema = new JSONSchema({ required: false })
...
describe('partial()', () => {
  ...
  it('should return a schema without required fields', () => {
    expect(partialSchema.getProperty('a')?.required).toBeFalsy()
    expect(partialSchema.getProperty('b')?.required).toBeFalsy()
  })

  it('should not modify parent schema', () => {
    expect(schema.getProperty('a')?.required).toBe(true)
  })
})
...
describe('required()', () => {
  ...
  it('should return a schema with all fields required', () => {
    expect(required.getProperty('a')?.required).toBe(true)
    expect(required.getProperty('b')?.required).toBe(true)
  })

  it('should not modify parent schema', () => {
    expect(schema.getProperty('a')?.required).toBeFalsy()
    expect(schema.getProperty('b')?.required).toBeFalsy()
  })
})
